...
film_path = st.sidebar.text_input("Path file film (Excel)", "film_asean_2020_2024.xls")
crime_path = st.sidebar.text_input("Path file kriminalitas (CSV)", "data_kriminalitas.csv")
